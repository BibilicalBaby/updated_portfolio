...
const HiddenMessage = ({ isRight }) => {
    return (
        <>
            {isRight ? (
                <div className={`flex gap-5 items-center justify-center bg-emerald-500 px-3 py-7 rounded-lg text-white translate-x-[99.9%] hover:translate-x-0 transition transform ease-out duration-500 `}>
                ...
                (<div className={`flex gap-5 items-center justify-center bg-sky-500 px-3 py-7 rounded-lg text-white translate-x-[-99.9%] hover:translate-x-0 transition transform ease-out duration-500`}>
                    <div>
                        <h2 className='font-normal text-lg py-2 text-center font-montserrat'>I develop web apps professionaly.</h2>
